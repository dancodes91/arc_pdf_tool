  ...
  "relative w-full rounded-lg border p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground",
  {
    variants: {
      variant: {
        ...
        error:
          "border-status-error-border bg-status-error-bg text-status-error-text [&>svg]:text-status-error-text",
        info:
          "border-status-info-border bg-status-info-bg text-status-info-text [&>svg]:text-status-info-text",
      },
    },
    defaultVariants: {
      variant: "default",
