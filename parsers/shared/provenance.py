...
class ProvenanceTracker:
    ...
    def create_parsed_item(
        ...
        **metadata,
        ...
        return ParsedItem(
            value=value, data_type=data_type, provenance=provenance, confidence=confidence
        )
...
class ProvenanceAnalyzer:
    ...
    def _generate_recommendations(
        self, method_counts: Dict[str, int], avg_confidence: float, issues: List[str]
    ) -> List[str]:
    ...
    def export_provenance_report(
        self, parsed_items: List[ParsedItem], output_file: str = None
    ) -> str:
...
def create_text_provenance(
    ...
    return tracker.create_provenance(raw_text=raw_text, bbox=bbox, confidence=confidence)
