...
class ConfidenceScorer:
    ...
    def score_effective_date(self, date_str: str, context: Dict[str, Any] = None) -> ConfidenceScore:
    ...
    def score_table_extraction(self, df: pd.DataFrame, expected_columns: List[str] = None) -> ConfidenceScore:
    ...
    def score_overall_extraction(self,
                                extraction_results: Dict[str, Any],
                                method_used: str,
                                table_quality: Optional[float] = None) -> ConfidenceScore:
