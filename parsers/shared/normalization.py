...
class DataNormalizer:
    ...
    def normalize_price(self, price_input: Union[str, float, int],
    ...
    def validate_normalized_data(self, data: Dict[str, Any],
                                data_type: str) -> ConfidenceScore:
