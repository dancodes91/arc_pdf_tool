...
class HagerMatrixParser:
    ...
    def extract_matrix_products(self, page_text: str, page_number: int) -> List[ParsedItem]:
        ...
        for entry in matrix_entries:
            ...
            product_data = {
                ...
                "specifications": {"size": size, "finish": finish},
                "manufacturer": "hager",
                "is_active": True,
            }
        ...
        for line_num, line in enumerate(lines):
            ...
            if price_only_match and current_size and current_finish:
                try:
                    ...
                    entries.append({"size": current_size, "finish": current_finish, "price": price})
            ...
            if finish_match and current_size:
                ...
                if price_match:
                    try:
                        ...
                        entries.append({"size": current_size, "finish": finish, "price": price})
    ...
    def is_matrix_page(self, page_text: str) -> bool:
        ...
        if is_matrix:
            logger.debug(
                f"Detected matrix page: model={has_model}, finishes={finish_count}, prices={has_prices}"
            )
