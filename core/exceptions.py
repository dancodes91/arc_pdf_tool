...
class ValidationError(BaseArcException):
    ...
    def __init__(self, message: str, field: str = None, http_status: int = 400, **kwargs):
        super().__init__(
            message=message, http_status=http_status, category=ErrorCategory.VALIDATION, **kwargs
        )
        if field:
...
class InvalidFileFormatError(ValidationError):
    ...
    def __init__(self, file_path: str, expected_format: str = None, **kwargs):
        super().__init__(
            ...
            context={"file_path": file_path, "expected_format": expected_format},
...
class ParseError(BaseArcException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(message=message, http_status=422, category=ErrorCategory.PARSING, **kwargs)
...
class PDFCorruptedError(ParseError):
    ...
    def __init__(self, file_path: str, details: str = None, **kwargs):
        super().__init__(
            ...
            context={"file_path": file_path, "details": details},
...
class OCRError(ParseError):
    ...
    def __init__(self, page_number: int = None, reason: str = None, **kwargs):
        super().__init__(
            ...
            context={"page_number": page_number, "reason": reason},
...
class TableShapeError(ParseError):
    ...
    def __init__(
        self, table_index: int = None, page_number: int = None, reason: str = None, **kwargs
    ):
        super().__init__(
            ...
            context={"table_index": table_index, "page_number": page_number, "reason": reason},
...
class RuleExtractionError(ParseError):
    ...
    def __init__(self, rule_type: str = None, pattern: str = None, **kwargs):
        super().__init__(
            ...
            context={"rule_type": rule_type, "pattern": pattern},
...
class ProcessingError(BaseArcException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message=message, http_status=422, category=ErrorCategory.PROCESSING, **kwargs
        )
...
class DataNormalizationError(ProcessingError):
    ...
    def __init__(self, data_type: str, value: Any, reason: str = None, **kwargs):
        super().__init__(
            ...
            context={"data_type": data_type, "value": str(value), "reason": reason},
...
class DiffMatchError(ProcessingError):
    ...
    def __init__(self, old_item: str = None, confidence: float = None, **kwargs):
        super().__init__(
            ...
            context={"old_item": old_item, "confidence": confidence},
...
class ConfidenceThresholdError(ProcessingError):
    ...
    def __init__(self, data_type: str, confidence: float, threshold: float, **kwargs):
        super().__init__(
            ...
            context={"data_type": data_type, "confidence": confidence, "threshold": threshold},
...
class BaserowError(ExternalServiceError):
    ...
    def __init__(self, operation: str, status_code: int = None, response: str = None, **kwargs):
        context = {"operation": operation, "status_code": status_code, "response": response}
        super().__init__(
            service="Baserow",
...
class RateLimitError(ExternalServiceError):
    ...
    def __init__(self, service: str, limit: int = None, reset_time: int = None, **kwargs):
        context = {"limit": limit, "reset_time": reset_time}
        super().__init__(
            service=service,
...
class UnsupportedExportFormatError(ExportError):
    ...
    def __init__(self, format_type: str, supported_formats: List[str] = None, **kwargs):
        super().__init__(
            ...
            context={"requested_format": format_type, "supported_formats": supported_formats},
...
class BusinessLogicError(BaseArcException):
    ...
    def __init__(self, message: str, **kwargs):
        super().__init__(
            message=message, http_status=422, category=ErrorCategory.BUSINESS, **kwargs
        )
